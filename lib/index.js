...
exports.default = (function (config) { return ({
    getList: function (resource, params) {
        ...
        return config.httpClient(url, options).then(function (_a) {
            ...
            return {
                data: json.map(function (obj) { return (0, urlBuilder_1.dataWithId)(obj, primaryKey); }),
    ...
    getOne: function (resource, params) {
        ...
        return config
            ...
            var json = _a.json;
            return ({
                data: (0, urlBuilder_1.dataWithId)(json, primaryKey),
            });
        });
    },
    getMany: function (resource, params) {
        ...
        return config
            ...
            var json = _a.json;
            return ({
                data: json.map(function (data) { return (0, urlBuilder_1.dataWithId)(data, primaryKey); }),
            });
        });
    },
    ...
    update: function (resource, params) {
        ...
        var primaryKey = (0, urlBuilder_1.getPrimaryKey)(resource, config.primaryKeys);
        var query = (0, urlBuilder_1.getQuery)(primaryKey, id, resource, meta);
        var primaryKeyData = (0, urlBuilder_1.getKeyData)(primaryKey, data);
        var url = "".concat(config.apiUrl, "/").concat(resource, "?").concat(qs_1.default.stringify(query));
        var metaSchema = (_a = params.meta) === null || _a === void 0 ? void 0 : _a.schema;
        var body = JSON.stringify(__assign(__assign({}, (0, urlBuilder_1.dataWithoutId)(data, primaryKey)), primaryKeyData));
        return config
            .httpClient(url, {
            method: 'PATCH',
            ...
            .then(function (_a) {
            var json = _a.json;
            return ({ data: (0, urlBuilder_1.dataWithId)(json, primaryKey) });
        });
    },
    updateMany: function (resource, params) {
        ...
        var body = JSON.stringify(params.ids.map(function (id) {
            ...
            var primaryKeyParams = (0, urlBuilder_1.decodeId)(id, primaryKey);
            var primaryKeyData = {};
            if ((0, urlBuilder_1.isCompoundKey)(primaryKey)) {
            ...
            return __assign(__assign({}, (0, urlBuilder_1.dataWithoutId)(data, primaryKey)), primaryKeyData);
        }));
    ...
    create: function (resource, params) {
        ...
        return config
            ...
            body: JSON.stringify((0, urlBuilder_1.dataWithoutId)(params.data, primaryKey)),
        })
            .then(function (_a) {
            var json = _a.json;
            return ({
